			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					while (rs.next()) {
						...
						li_viewList
								.add(eno + "   " + ename + "   " + etel + "   " + gname + "   " + eid + "   " + temp);
						temp = "";
					}
					rs.close();
					ps.close();
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (int i = 1; i < 7; i++) {
						switch (i) {
						case 1:
							tf_viewNo.setText(str.nextToken());
							break;
						case 2:
							tf_viewName.setText(str.nextToken());
							break;
						case 3:
							tf_viewTel.setText(str.nextToken());
							break;
						case 4:
							c_viewGrade.select(str.nextToken());
							break;
						case 5:
							tf_viewId.setText(str.nextToken());
							break;
						case 6:
							tf_viewPwd.setText(str.nextToken());
							break;
						}
					}
				} catch (Exception e1) {
